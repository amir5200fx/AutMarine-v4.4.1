...
namespace AutLib
{
	...
	class Aft_Edge
		: public Mesh_Edge<typename EdgeTraits::nodeType>
		, public Mesh_EdgeAdaptor<typename EdgeTraits::elementType>
	...
	public:
		...
		typedef Mesh_Edge<typename EdgeTraits::nodeType> base;
		typedef Mesh_EdgeAdaptor<typename EdgeTraits::elementType> adaptor;

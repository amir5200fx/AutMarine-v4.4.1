...
namespace AutLib
{
	...
	std::shared_ptr<Entity2d_Chain> Mesh_PlnCurve<CrvEntity>::Discrete
	(
	...
	template<class CrvEntity>
	std::shared_ptr<Entity2d_Chain> Mesh_PlnCurve<CrvEntity>::Mesh
	(
	...
	std::shared_ptr<Entity2d_Chain> Mesh_PlnCurve<CrvEntity>::MeshTemp
	(
	...
	std::vector<std::shared_ptr<EdgeType>> Mesh_PlnCurve<CrvEntity>::TopoMesh
	(

...
namespace AutLib
{
	...
	typedef Geo_ColoringSurfMetric::elementColor elementColor;
	...
	)
	{
		...
		if (theMap)
		{
			RegisterElementsOnSingularities<SizeMap2d_Surface>::_
			(
				theElements,
				theSurface,
				*theMap,
...
Standard_Integer
AutLib::Geo_ColoringSurfMetric::Value
(
...
void AutLib::Geo_ColoringSurfMetric::Perform()
{
	if (NOT theApprox_)
	{
		FatalErrorIn("void AutLib::Geo_ColoringSurfMetric::Perform()")
	...
	const auto invMaxDet =
		(Standard_Real)1.0 / info.MaxDeterminant();

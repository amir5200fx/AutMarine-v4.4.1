...
namespace AutLib
{
	...
	extern std::shared_ptr<Numeric_AdaptIntegrationInfo> mesh_curve_overall_length_integration_info;
	extern std::shared_ptr<Numeric_AdaptIntegrationInfo> mesh_curve_newton_integration_info;

	extern std::shared_ptr<Numeric_NewtonSolverInfo> mesh_curve_newton_iter_info;

	extern std::shared_ptr<Mesh_CurveOptmPoint_CorrectionInfo>
		mesh_curve_point_corr_info;
	...
	public:
		...
		{
			theOverallLengthIntgInfo_ = mesh_curve_overall_length_integration_info;
			theNewtonIntgInfo_ = mesh_curve_newton_integration_info;

			theNewtonIterInfo_ = mesh_curve_newton_iter_info;

			theCorrAlgInfo_ = mesh_curve_point_corr_info;
		}
	...
	extern std::shared_ptr<Mesh_CurveInfo> mesh_curve_info;

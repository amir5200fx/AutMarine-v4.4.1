...
namespace AutLib
{
	...
	namespace gModel
	{
		...
		)
		{
			...
			auto curveOnPlane = std::make_shared<GModel_parCurve>(u0, u1, pCurve, gmodel_parcurve_info);
			...
			if (Curve)
			{
				auto curveOnSurface = std::make_shared<GModel_Curve>(U0, U1, Curve, gmodel_curve_info);

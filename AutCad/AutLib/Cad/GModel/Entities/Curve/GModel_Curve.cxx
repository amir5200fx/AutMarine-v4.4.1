...
) const
{
	...
	theC1 = std::make_shared<GModel_Curve>(FirstParam(), x, Curve(), gmodel_curve_info);
	theC2 = std::make_shared<GModel_Curve>(x, LastParam(), Curve(), gmodel_curve_info);
}

std::shared_ptr<AutLib::Cad_CurveInfo> 
AutLib::gmodel_curve_info = std::make_shared<AutLib::Cad_CurveInfo>();